...
describe("Hugo API - Schema Validations", async () => {
  ...
  describe("POST /applications", () => {
    ...
    describe("Primary Driver", () => {
      describe("First Name", () => {
        ...
        test("should not create a new application with invalid first name", async () => {
          ...
          expect(validationResults.summary).toBe(
      ...
      describe("Last Name", () => {
        ...
        test("should not create a new application with invalid last name", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "primaryDriver.lastName: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Gender", () => {
        ...
        test("should not create a new application with an invalid gender", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toEqual(
            `primaryDriver.gender: Invalid enum value. Expected 'male' | 'female' | 'non-binary', received 'other'`,
          );
        });
      });
      ...
      describe("Marital Status", () => {
        ...
        test("should not create a new application with an invalid marital status", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            `primaryDriver.maritalStatus: Invalid enum value. Expected 'single' | 'married' | 'divorced' | 'widowed', received 'other'`,
          );
        });
      });
      ...
      describe("Drivers License", () => {
        describe("Number", () => {
          ...
          test("should not create a new application with an invalid drivers license number", async () => {
            ...
            expect(validationResults.statusCode).toBe(400);
            expect(validationResults.summary).toBe(
              "primaryDriver.driversLicense.number: String must contain exactly 9 character(s); primaryDriver.driversLicense.state: Required",
            );
          });
        });
        ...
        describe("State", () => {
          ...
          test("should not create a new application with an invalid drivers license state", async () => {
            ...
            expect(validationResults.statusCode).toBe(400);
            expect(validationResults.summary).toBe(
              `primaryDriver.driversLicense.number: Required; primaryDriver.driversLicense.state: Invalid enum value. Expected 'AL' | 'AK' | 'AZ' | 'AR' | 'CA' | 'CO' | 'CT' | 'DE' | 'FL' | 'GA' | 'HI' | 'ID' | 'IL' | 'IN' | 'IA' | 'KS' | 'KY' | 'LA' | 'ME' | 'MD' | 'MA' | 'MI' | 'MN' | 'MS' | 'MO' | 'MT' | 'NE' | 'NV' | 'NH' | 'NJ' | 'NM' | 'NY' | 'NC' | 'ND' | 'OH' | 'OK' | 'OR' | 'PA' | 'RI' | 'SC' | 'SD' | 'TN' | 'TX' | 'UT' | 'VT' | 'VA' | 'WA' | 'WV' | 'WI' | 'WY', received 'C'`,
            );
          });
        });
      });
    ...
    describe("Mailing Address", () => {
      ...
      test("should not create a new application with an invalid mailing address", async () => {
        ...
        expect(validationResults.statusCode).toBe(400);
        expect(validationResults.summary).toBe(
          `mailingAddress.state: Invalid enum value. Expected 'AL' | 'AK' | 'AZ' | 'AR' | 'CA' | 'CO' | 'CT' | 'DE' | 'FL' | 'GA' | 'HI' | 'ID' | 'IL' | 'IN' | 'IA' | 'KS' | 'KY' | 'LA' | 'ME' | 'MD' | 'MA' | 'MI' | 'MN' | 'MS' | 'MO' | 'MT' | 'NE' | 'NV' | 'NH' | 'NJ' | 'NM' | 'NY' | 'NC' | 'ND' | 'OH' | 'OK' | 'OR' | 'PA' | 'RI' | 'SC' | 'SD' | 'TN' | 'TX' | 'UT' | 'VT' | 'VA' | 'WA' | 'WV' | 'WI' | 'WY', received 'C'`,
        );
      });
      ...
      describe("Street", () => {
        ...
        test("should not create a new application with an invalid mailing address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "mailingAddress.street: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Unit", () => {
        ...
        test("should not create a new application with an invalid unit in mailing address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "mailingAddress.unit: Expected string, received number",
          );
        });
      });
      ...
      describe("City", () => {
        ...
        test("should not create a new application with an invalid city in mailing address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "mailingAddress.city: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Zip", () => {
        ...
        test("should not create a new application with an invalid zip length in mailing address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "mailingAddress.zip: String must contain exactly 5 character(s); mailingAddress.zip: Invalid",
          );
        });
        ...
        test("should not create a new application with an invalid zip type in mailing address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "mailingAddress.zip: Expected string, received number",
          );
        });
      });
    });
    ...
    describe("Garaging Address", () => {
      ...
      test("should not create a new application with an invalid garaging address", async () => {
        ...
        expect(validationResults.statusCode).toBe(400);
        expect(validationResults.summary).toBe(
          `garagingAddress.state: Invalid enum value. Expected 'AL' | 'AK' | 'AZ' | 'AR' | 'CA' | 'CO' | 'CT' | 'DE' | 'FL' | 'GA' | 'HI' | 'ID' | 'IL' | 'IN' | 'IA' | 'KS' | 'KY' | 'LA' | 'ME' | 'MD' | 'MA' | 'MI' | 'MN' | 'MS' | 'MO' | 'MT' | 'NE' | 'NV' | 'NH' | 'NJ' | 'NM' | 'NY' | 'NC' | 'ND' | 'OH' | 'OK' | 'OR' | 'PA' | 'RI' | 'SC' | 'SD' | 'TN' | 'TX' | 'UT' | 'VT' | 'VA' | 'WA' | 'WV' | 'WI' | 'WY', received 'C'`,
        );
      });
      ...
      describe("Street", () => {
        ...
        test("should not create a new application with an invalid garaging address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "garagingAddress.street: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Unit", () => {
        ...
        test("should not create a new application with an invalid unit in garaging address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "garagingAddress.unit: Expected string, received number",
          );
        });
      });
      ...
      describe("City", () => {
        ...
        test("should not create a new application with an invalid city in garaging address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "garagingAddress.city: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Zip", () => {
        ...
        test("should not create a new application with an invalid zip length in garaging address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "garagingAddress.zip: String must contain exactly 5 character(s); garagingAddress.zip: Invalid",
          );
        });
        ...
        test("should not create a new application with an invalid zip type in garaging address", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "garagingAddress.zip: Expected string, received number",
          );
        });
      });
    });
    ...
    describe("Vehicles", () => {
      ...
      describe("Make", () => {
        ...
        test("should not create a new application with an invalid make", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "vehicles.ABC123.make: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Model", () => {
        ...
        test("should not create a new application with an invalid model", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "vehicles.ABC123.model: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Year", () => {
        ...
        test("should not create a new application with an invalid year", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "vehicles.ABC123.year: Number must be greater than or equal to 1985",
          );
        });
      });
      ...
      describe("Vin", () => {
        ...
        test("should not create a new application with an invalid vin length", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "vehicles.ABC123.vin: String must contain exactly 17 character(s); vehicles.ABC123.vin: Invalid VIN check digit",
          );
        });
        ...
        test("should not create a new application with an invalid vin sequence", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "vehicles.ABC123.vin: Invalid VIN check digit",
          );
        });
      });
    });
    ...
    describe("Additional Drivers", () => {
      describe("First Name", () => {
        ...
        test("should not create a new application with invalid first name", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1.firstName: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Last Name", () => {
        ...
        test("should not create a new application with invalid last name", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1.lastName: String must contain at least 2 character(s)",
          );
        });
      });
      ...
      describe("Date of Birth", () => {
        ...
        test("should not create a new application with invalid date of birth", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1.dateOfBirth: Date must be in YYYY-MM-DD format",
          );
        });
        ...
        test("should not create a new application if age is < 18", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1.dateOfBirth: Must be at least 18 years old",
          );
        });
      });
      ...
      describe("Gender", () => {
        ...
        test("should not create a new application with an invalid gender", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toEqual(
            `additionalDrivers.Driver1.gender: Invalid enum value. Expected 'male' | 'female' | 'non-binary', received 'other'`,
          );
        });
      });
      ...
      describe("Relationship", () => {
        ...
        test("should not create a new application with an invalid relationship", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            `additionalDrivers.Driver1.relationship: Invalid enum value. Expected 'spouse' | 'child' | 'parent' | 'sibling' | 'other', received 'cousin'`,
          );
        });
      });
      ...
      describe("Marital Status", () => {
        test("should not create a new application if marital status received", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1: Unrecognized key(s) in object: 'maritalStatus'",
          );
        });
      });
      ...
      describe("Drivers License", () => {
        test("should not create a new application if drivers license received", async () => {
          ...
          expect(validationResults.statusCode).toBe(400);
          expect(validationResults.summary).toBe(
            "additionalDrivers.Driver1: Unrecognized key(s) in object: 'driversLicense'",
          );
        });
      });
    });
